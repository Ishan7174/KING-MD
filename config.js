...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'ISHAN KAWISH' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'ISHAN KAWISH' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'ISHAN' : process.env.PACK_NAME.split(";")[1],
